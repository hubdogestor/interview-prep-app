;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="0add3e0b-dcb1-596a-f63e-4c3e9f0b6be9")}catch(e){}}();
module.exports = [
...
"[project]/src/types/profile.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/server/routers/profile.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/trpc.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$profile$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/types/profile.ts [app-route] (ecmascript)");
;
;
async function getProfileMetrics(prisma) {
...
function buildProfileSummary(profile, metrics) {
    if (!profile) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$profile$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["placeholderProfileSummary"];
    }
    const resumo = profile.resumo ?? null;
    const metricItems = [
        {
            key: "experience",
            label: "Experiência",
        ...
        },
        {
            key: "icebreakers",
            label: "Icebreakers",
            value: metrics.icebreakers.toString()
        },
        {
            key: "competencias",
            label: "Competências",
            value: metrics.competencias.toString()
        },
        {
            key: "experiencias",
            label: "Experiências",
            value: metrics.experiencias.toString()
        },
        {
            key: "speeches",
            label: "Speeches",
            value: metrics.speeches.toString()
        },
        {
            key: "questions",
            label: "Perguntas",
            value: metrics.questions.toString()
        }
    ];
    const links = [];
    if (profile.email) links.push({
        type: "email",
        label: "E-mail",
        value: profile.email
    });
    if (profile.telefone) links.push({
        type: "phone",
        label: "Telefone",
        value: profile.telefone
    });
    if (profile.linkedin) links.push({
        type: "linkedin",
        label: "LinkedIn",
        value: profile.linkedin
    });
    if (profile.github) links.push({
        type: "github",
        label: "GitHub",
...
const profileRouter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["router"])({
    summary: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["publicProcedure"].query(async ({ ctx })=>{
        try {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$routers$2f$profile$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/routers/profile.ts [app-route] (ecmascript)");
;
;
;
const appRouter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["router"])({
    ...
    profile: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$routers$2f$profile$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["profileRouter"]
});
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0428d25d._.js.map