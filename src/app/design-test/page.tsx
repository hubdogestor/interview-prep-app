        ...
        <aside className="dashboard-sidebar">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-grotesk text-lg font-semibold text-text-primary">
                Interview Prep App
              </p>
            </div>
          </div>
          ...
          <section className="analytics-grid">
            <div className="card">
              ...
              <svg className="mt-6 h-48 w-full" viewBox="0 0 400 200" fill="none">
                ...
                <path
                  d="M20 152L100 120L180 140L260 78L340 110"
                  stroke="#F6C445"
                  strokeWidth={3}
                  strokeLinecap="round"
                />
              ...
              <div className="mt-6 grid grid-cols-2 gap-6">
                {timeline.map((item) => (
                  <div key={item.label} className="rounded-2xl border border-border-subtle bg-bg-tertiary/70 p-4">
                    ...
                    <p className="mt-2 text-2xl font-mono font-semibold text-text-primary">
                      {item.value}%
                    </p>
                    <p
                      className={`text-xs font-medium ${
                        item.tone === "positive" ? "trend-positive" : "text-brand-yellow"
                      }`}
                    >
                      Evolucao continua
                    </p>
            ...
            <div className="card">
              ...
              <ul className="mt-6 space-y-4">
                {reviewChecklist.map((item) => (
                  <li key={item.title} className="flex items-start justify-between gap-4 rounded-2xl border border-border-subtle/60 bg-bg-tertiary/60 p-4">
                    <div>
              ...
              <div className="mt-8 rounded-2xl bg-gradient-to-br from-brand-blue/20 via-brand-green/15 to-brand-lime/20 p-6 text-sm text-text-primary">
                ...
                <p className="mt-2 text-text-secondary">
                  Explore respostas narrativas com o framework STAR e destaque um resultado
                  mensuravel por historia.
                </p>
              </div>
            </div>
