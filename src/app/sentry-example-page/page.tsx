...
function Description() {
  return (
    <p className="description">
      ...
      <a target="_blank" href="https://hub-do-gestor.sentry.io/organizations/hub-do-gestor/issues/?project=4510103763550208">
        Issues Page
      </a>
...
function MainContent({
  ...
  isConnected: boolean;
  setHasSentError: (value: boolean) => void;
  hasSentError: boolean;
}) {
  return (
    <main>
  ...
  return (
    <div>
      ...
      <MainContent
        ...
        setHasSentError={setHasSentError}
