...
import MobileNotifications from "@/components/dashboard-v0/notifications/mobile-notifications";
...
export function MobileHeader({ notifications, label }: MobileHeaderProps) {
