...
export function PreparationStatusBoard({ statuses }: PreparationStatusProps) {
  return (
    <DashboardCard
      title="Status da preparação"
      intent="success"
      addon={<Badge variant="outline-success">Em evolução</Badge>}
    >
...
export default PreparationStatusBoard;
